...
public class DialogBox extends HBox {
    ...
    /**
     * Creates a dialog box for Luna with the given text and image, and flips it so that the ImageView is on the left.
     *
     * @param text The text to be displayed in the dialog box.
     * @param img The image to be displayed in the dialog box.
     * @return A DialogBox instance representing Luna's dialog.
     */
