...
public class MainWindow extends AnchorPane {
    ...
    /** Injects the Alexis instance */
    public void setAlexis(Alexis a) {
        alexis = a;
    }
    ...
    private void handleUserInput() {
        ...
        String response = alexis.input(input);
        dialogContainer.getChildren().addAll(
                DialogBox.getUserDialog(input, userImage),
                DialogBox.getAlexisDialog(response, dukeImage)
        );
        userInput.clear();
    }
}
