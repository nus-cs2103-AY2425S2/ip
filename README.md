...
1. After that, locate the `src/main/java/Eve.java` file, right-click it, and choose `Run Eve.main()` (if the code editor is showing compile errors, try restarting the IDE). 
